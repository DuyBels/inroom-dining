            ...
            child: Column(
              ...
              children: [
                ...
                if (_showDebugPanel) ...[
                  ...
                  _buildDebugButton('PHÒNG 202 (KHÁCH)', 'room2@app.com', '123123', Colors.blue),
                  _buildDebugButton('BẾP Á', 'bepa@app.com', '123123', Colors.orange),
                  _buildDebugButton('BẾP ÂU', 'bepau@app.com', '123123', Colors.orange[900]!),
                  _buildDebugButton('NHÂN VIÊN 1 (WAITER)', 'waiter@app.com', '123123', Colors.green),
                  _buildDebugButton('NHÂN VIÊN 2 (WAITER)', 'waiter2@app.com', '123123', Colors.green),
                ],
              ],
            ),
          ),
