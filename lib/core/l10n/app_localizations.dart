...
class AppDictionary {
  ...
  final String selectExistingGroup;
  ...
  AppDictionary({
    ...
    required this.selectExistingGroup,
...
final viDict = AppDictionary(
  ...
  checkout: "Thanh toán",
  total: "TỔNG CỘNG",
  aiSuggestion: "GỢI Ý DÀNH CHO BẠN",
  all: "Tất cả",
  login: "Đăng nhập",
  logout: "Đăng xuất",
  pending: "Đang chờ",
  ...
  aiAssistant: "Trợ lý gợi ý món",
  aiIntro: "Chào bạn! Để hệ thống gợi ý món phù hợp nhất, hôm nay bạn muốn dùng món thế nào?",
  cool: "Nắng nóng",
  warm: "Lạnh",
  estimatedFinish: "Dự kiến hoàn thành sau khoảng",
  includeDelivery: "Bao gồm thời gian chuẩn bị & 5 phút giao hàng",
  ...
  priceLabel: "Giá tiền",
  cookTimeLabel: "Thời gian chẩn bị (phút)",
  ...
  addGroupTitle: "Thêm Nhóm Tùy Chọn Mới",
  selectExistingGroup: "Chọn nhóm có sẵn",
  editGroupTitle: "Sửa Nhóm Tùy Chọn",
...
final enDict = AppDictionary(
  ...
  checkout: "Checkout",
  total: "TOTAL",
  aiSuggestion: "RECOMMENDED FOR YOU",
  all: "All",
  login: "Login",
  logout: "Logout",
  pending: "Pending",
  ...
  aiAssistant: "Menu Assistant",
  aiIntro: "Hi! To suggest the best meal for you, how would you like your food today?",
  cool: "Hot",
  warm: "Cold",
  ...
  addGroupTitle: "Add New Modifier Group",
  selectExistingGroup: "Select Existing Group",
  editGroupTitle: "Edit Modifier Group",
